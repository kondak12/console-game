...
seller_page = "\nВы прибыли к торговцу. Он осмотрел вас со словами: 'ДААА, выглядишь не очень... ЕСТЬ ПАРОЧКА ТОваров которые могут ИСПРАВИТЬ это!'.\n"
...
seller_medvejevika = "Медвежевика -> 'обычная ягода' -> лечит персонажа на 10 hp -> 3 золотых"

seller_sword_1 = "Железный меч -> 'выкован руками торговца' -> увеличивает урон персонажа на 4 -> 8 золотых"
