...
def act_3_action_2_choose_1(name):
...
def dragon_phrase_1(dmg):
    r = "Дракон кружит над вами и швыряет в вас огненный шарик. Вы выстояли. Он нанёс " + f"{dmg}" + " урона."
    return f"{r}"

def dragon_phrase_2(dmg):
    r = "Дракон ударил вас когтем. Вы выстояли. Он нанёс " +  f"{dmg}" +  " урона."
    return f"{r}"

def dragon_phrase_3(dmg):
    r = "Дракон смахнул вас крылом в обломки крыши. Вы выстояли. Он нанёс " + f"{dmg}" + " урона."
    return f"{r}"
